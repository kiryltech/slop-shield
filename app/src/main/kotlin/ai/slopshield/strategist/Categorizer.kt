...
class Categorizer(
    ...
    private val prompt = """
        ...
        Estimate how much of this content was generated or structured by an AI/LLM. Be skeptical:
        - HAND_CRAFTED: Organic, unique human writing. NEVER touched by AI. Shows personal friction and idiosyncratic style.
        - ASSISTED: Human-led, but lightly polished, proofread, or outlined by AI.
        - COLLABORATIVE: Human ideas, but heavy AI execution/padding.
        - HIGH_AI: Primarily AI-generated based on a prompt.
        - PURE_SLOP: Raw, unedited AI output.
        - UNKNOWN: Undetermined.

        ### Part 3: Output Format
        Output ONLY a raw JSON object (no markdown blocks).
        The 'aiInvolvementReasoning' MUST be short (max 40 words).
        ...
        Format: 
        {
            ...
            "aiInvolvementReasoning": "Short explanation of AI markers found or missing (max 40 words)."
        }
    """.trimIndent()
